...
class AllDevicesCard
    extends TbContextWidget<AllDevicesCard, _AllDevicesCardState> {
...
class _AllDevicesCardState
    extends TbContextState<AllDevicesCard, _AllDevicesCardState> {
...
class DeviceProfileCard
    extends TbContextWidget<DeviceProfileCard, _DeviceProfileCardState> {
...
class _DeviceProfileCardState
    extends TbContextState<DeviceProfileCard, _DeviceProfileCardState> {
