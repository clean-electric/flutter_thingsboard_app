...
class TbAppBar extends TbContextWidget<TbAppBar, _TbAppBarState>
...
class TbAppSearchBar
    extends TbContextWidget<TbAppSearchBar, _TbAppSearchBarState>
    implements PreferredSizeWidget {
  final double? elevation;
  final Color? shadowColor;
  final bool showLoadingIndicator;
...
class _TbAppSearchBarState
    extends TbContextState<TbAppSearchBar, _TbAppSearchBarState> {
